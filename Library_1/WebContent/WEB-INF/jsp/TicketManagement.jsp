...
<div class="preloader">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="<c:url value="/admin" />">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="style/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="style/assets/images/logo-text.png" alt="homepage" class="light-logo" height="28px" width="152px" />
                        ...
                        <!-- <b class="logo-icon"> -->
                            <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
                            <!-- Dark Logo icon -->
                            <!-- <img src="style/assets/images/logo-text.png" alt="homepage" class="light-logo" /> -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="style/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<c:url value="/userticket" />" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">User Ticket</span></a></li>
        ...
        <div class="page-wrapper">
            ...
            <br>
            <p align="right"><input id="search" type="text" placeholder="Search.." ></p>
            <br>
            <table id="table">
            <thead>
            <tr>
            <th>ID</th><th>Book Title</th><th>User Name</th><th>Price</th><th>Status</th><th>Date Open</th><th>Date Close</th><th>User Closed</th><th>Action</th>
            </tr>
            <thead>
            <tbody id="myTable">            
            ...
            <c:if test = "${ticket.status == 1}">
            <td><a href="<c:url value='/closeTicket${ticket.id}/${ticket.book_id}/${ticket.user_id }'></c:url>" id = "returned">Return</a></td>
            </c:if>
            <c:if test = "${ticket.status == 0}">
            <td><p>Returned</p></td>
            </c:if>
    ...
    <script src="style/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
